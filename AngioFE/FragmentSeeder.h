...
public:
	...
	virtual bool SeedFragments(std::vector<AngioElement*>& angio_elements, 
								FEMesh* mesh, FEAngioMaterial* angio_mat, 
								int buffer_index) = 0;
...
//! choosen, seeds 2 oppositly directed tips at each loaction that is choosen
